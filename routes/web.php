...
// });
    ...
    Route::get('/staff-keuangan/detail-data-mahasiswa/{nim}', [StaffDetailDataMahasiswaController::class, 'index'])->name('staff-keuangan.data-mahasiswa.detail-data-mahasiswa');
