    ...
    // });
        ...
        Route::post('/admin/kelola-pengguna', [\App\Http\Controllers\Admin\KelolaPenggunaController::class, 'store'])->name('admin.kelola-pengguna.store');
        Route::get('/admin/kelola-pengguna/{id}/edit', [\App\Http\Controllers\Admin\KelolaPenggunaController::class, 'edit'])->name('admin.kelola-pengguna.edit');
        Route::put('/admin/kelola-pengguna/{id}', [\App\Http\Controllers\Admin\KelolaPenggunaController::class, 'update'])->name('admin.kelola-pengguna.update');
        Route::delete('/admin/kelola-pengguna/{id}', [\App\Http\Controllers\Admin\KelolaPenggunaController::class, 'destroy'])->name('admin.kelola-pengguna.destroy');
