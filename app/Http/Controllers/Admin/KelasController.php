        ...
        try {
            ...
            if ($response->successful()) {
                ...
                if (isset($result['data']) && is_array($result['data'])) {
                    // Map program studi names and get tahun angkatan list
                    $kelasData = $this->mapProdiNames($result['data'], $prodiList);
                    $result['data'] = $kelasData;
                    $kelas = $this->createPaginationObject($result, $request);
                } else {
