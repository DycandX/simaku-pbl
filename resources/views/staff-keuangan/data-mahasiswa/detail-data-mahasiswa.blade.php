            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p><strong>Golongan UKT:</strong> {{ $studentData[0]['enrollment']['id_golongan_ukt'] ?? 'Tidak Tersedia' }}</p>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $paymentData[0]['metode_pembayaran'] }}</td> <!-- Metode Pembayaran -->
                                ...
                                <td><span class="badge {{ $payment['status'] == 'belum_bayar' ?  'badge-danger' : 'badge-info' }}">{{ ucfirst($payment['status']) }}</span></td>
                                <td>{{ $payment['jenis_pembayaran']['deskripsi'] }}</td> <!-- Metode Pembayaran -->
